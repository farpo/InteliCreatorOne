...
/*
    private static String createBlockAndItem(String name, String block, String itemgroup){
        return block;
    }
    public static final String MOCK_BLOCK = createBlockAndItem("mock_block", "new Block(QuiltBlockSettings().create)", "ItemGroups.INGREDIENTS");
